...
/**
 * LifeBridge – On‑site Chatbot (voice + i18n + dynamic knowledge)
 * ----------------------------------------------------------------
 * - Navigačný asistent pre tvoj web (Domov, Prihlásenie, Registrácia, Profil, Používatelia)
 * - Rozpoznávanie reči podľa jazyka (SK/EN) – Web Speech API
 * - TTS (predčítavanie odpovedí) v SK/EN
 * - Načítanie vedomostí zo servera (/api/site-map, /api/offers) – voliteľné
 * - Bez externých API kľúčov, čisto frontend
 */
...
// --------- Fallback znalosti (ak backend nevráti /api/site-map a /api/offers) ---------
...
const speak = (text: string, lang: Lang) => {
  ...
  // ponecháme výber hlasu na OS, aby nebolo treba povolenia
